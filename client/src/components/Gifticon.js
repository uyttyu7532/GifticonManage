    ...
    render() {
        return (
            <TableRow>
                ...
                <TableCell><img src={`http://ec2-3-34-44-135.ap-northeast-2.compute.amazonaws.com/${this.props.barcode_img}`} alt="barcode_img" style={{ width: 64, height: 64 }}></img></TableCell>
