    ...
    render() {
        return (
            <TableRow>
                ...
                <TableCell><img src={`https://ec2-15-164-50-1.ap-northeast-2.compute.amazonaws.com/api/gifticons/${this.props.barcode_img}`} alt="barcode_img" style={{ width: 64, height: 64 }}></img></TableCell>
